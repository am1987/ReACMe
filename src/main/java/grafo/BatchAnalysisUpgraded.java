...
public class BatchAnalysisUpgraded {
	...
	public static void main(String[] args) throws IOException,InterruptedException {
		...
		if(!nested) {
			LogUtilsRepeatingGraph lurg;
			lurg= iteration(0.0,0.0,0.0,null);
			lurg= iteration(0.0,1.0,0.0,lurg);
			lurg= iteration(0.5,0.0,0.0,lurg);
			lurg= iteration(0.5,1.0,1.0,lurg);
			lurg= iteration(0.5,0.0,1.0,lurg);
			lurg= iteration(0.5,1.0,0.0,lurg);
			lurg= iteration(1.0,0.0,0.0,lurg);
			lurg= iteration(1.0,0.0,1.0,lurg);
